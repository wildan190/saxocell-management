    ...
    <div class="max-w-3xl mx-auto">
        <div class="md:flex md:items-center md:justify-between mb-8">
            <div class="flex-1 min-w-0">
                <h2 class="text-3xl font-bold leading-7 text-slate-900 sm:truncate tracking-tight">Add New Store</h2>
                <p class="mt-2 text-sm text-slate-500">Create a new retail location to manage its inventory and finances.
                </p>
            </div>
        </div>
